...
teks = `I can't join the group untill  *Nexxer* ask me to join. Type *-owner* to get Nexxer number and ask him.`
...
case 'swm': case 'take': case 'stickerwm': case 'steal':{
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
if (!args.join(" ")) return reply(`Use command: -steal Hinata|By: Nexxer`)
const swn = args.join(" ")
...
case '':
    ...
    if (isBanChat) return reply(mess.bangc)
      ...
      mikupic ='https://telegra.ph/file/716b0145a9c9ce6ac4f87.jpg'
...
const mikuarray= [
            "https://media.tenor.com/I985O8a-A3YAAAPo/naruto.mp4",
            "https://media.tenor.com/hQh6hXeFvV0AAAPo/hinata-hyuga.mp4",
            "https://media.tenor.com/YU_4AHLiZz4AAAPo/naruto-hyuuga-hinata.mp4",
            "https://media.tenor.com/pPs96yVTLQwAAAPo/hinata-mad.mp4",
            "https://media.tenor.com/yvLuq2lC_uIAAAPo/hinata.mp4",
            "https://media.tenor.com/xTwdyMbjNS0AAAPo/naruto-hinata.mp4",
            "https://media.tenor.com/eiZsNe0hWlIAAAPo/hinata-hyuga-naruto.mp4",
            "https://media.tenor.com/bHr7VyGzWiEAAAPo/hinata-hyuga.mp4",
            "https://media.tenor.com/v7_qayccrrwAAAPo/hinata-naruto.mp4",
            "https://media.tenor.com/OoX5a1B0tfEAAAPo/hyuuga-hinata.mp4",
            "https://tenor.com/en-IN/view/hinata-hinata-hyuga-gif-19872336",
            "https://media.tenor.com/ALt5ymXfgoAAAAPo/hinata-hinata-hyuga.mp4",
            "https://media.tenor.com/Ywg1mRKe09IAAAPo/naruto-shippuden-anime.mp4",
            "https://media.tenor.com/SnWzAmED9wsAAAPo/naruto-naruto-shippuden.mp4",
            "https://media.tenor.com/V0gPL86Q_CwAAAPo/hinata-hyuga-nami.mp4"
